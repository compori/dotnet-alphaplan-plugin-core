...
namespace Compori.Alphaplan.Plugin.Support.Data
{
    public sealed class Table : ITable
    {
        ...
        private ITable Seek(long id)
        {
            ...
            var result = this.Writer.AddConstraintViaWhereString(this.Handle, ref filter);
        ...
        private ITable Create(bool insertBefore)
        {
            try
            {
                if (!this.Writer.AddNew(this.Handle, ref insertBefore))
                {
        ...
        private T GetValue<T>(string field)
        {
            ...
            {
                result = (float)this.Writer.GetDoubleValue(this.Handle, ref field);
            }
            else if (typeof(T) == typeof(double))
            {
                result = this.Writer.GetDoubleValue(this.Handle, ref field);
            }
            else if (typeof(T) == typeof(DateTime))
            {
                result = this.Writer.GetDateTimeValue(this.Handle, ref field);
            }
            else if (typeof(T) == typeof(bool))
            {
                result = this.Writer.GetBoolValue(this.Handle, ref field);
            }
            else if (typeof(T) == typeof(string))
            {
                result = this.Writer.GetStringValue(this.Handle, ref field);
            }
            else if (typeof(T) == typeof(byte[]))
            {
                result = this.Writer.GetBinaryValue(this.Handle, ref field);
        ...
        private ITable Set<T>(string field, T value)
        {
            ...
            try
            {
                ...
                this.Writer.SetValue(this.Handle, ref field, ref stringValue);
