...
namespace Compori.Alphaplan.Plugin.Support.Common.Version2100287
{
    public class ProtocolProvider : IProtocolProvider, IDisposable
    {
        /// <summary>
        /// Gets or sets the Alphaplan Protokoll API.
        /// </summary>
        /// <value>The Alphaplan Protokoll API.</value>
        private Base.Werkzeuge.IProtokoll Protokoll { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="ProtocolProvider"/> class.
        /// </summary>
        /// <param name="protokoll">The Alphaplan Protokoll API.</param>
        protected ProtocolProvider(Base.Werkzeuge.IProtokoll protokoll)
        {
        ...
        void IProtocolProvider.Write(ProtocolPriority priority, string message, Exception exception)
        {
            ...
            this.Protokoll.WriteDb(messageText, priorityValue, 0, error);
        }
