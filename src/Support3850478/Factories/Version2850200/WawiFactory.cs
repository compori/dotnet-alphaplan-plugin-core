...
namespace Compori.Alphaplan.Plugin.Support.Factories.Version2850200
{
    public class WawiFactory
    {
        ...
        {
            return this.Manager.ManagedObject(Names.Dokument) as IDokument;
        }
        ...
        {
            return this.Manager.ManagedObject(Names.SternPaket) as ISternPaket;
        }
        ...
        {
            return this.Manager.ManagedObject(Names.Stueckliste) as IStueckliste;
        }
